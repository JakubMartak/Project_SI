            ...
            <div class="row gy-5 gx-4">
                ...
                <div class="col-lg-4">
                    <div class="bg-light rounded p-5 mb-4 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <p><i class="fa fa-angle-right text-success me-2"></i>Published On: 01 Jan, 2045</p>
                        <p><i class="fa fa-angle-right text-success me-2"></i>Vacancy: 123 Position</p>
                        <p><i class="fa fa-angle-right text-success me-2"></i>Job Nature: Full Time</p>
                        <p><i class="fa fa-angle-right text-success me-2"></i>Salary: $123 - $456</p>
                        <p><i class="fa fa-angle-right text-success me-2"></i>Location: New York, USA</p>
                        <p class="m-0"><i class="fa fa-angle-right text-success me-2"></i>Date Line: 01 Jan, 2045</p>
                    </div>
