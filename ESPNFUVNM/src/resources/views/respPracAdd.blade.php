            ...
            <div class="row g-4">
                ...
                <div class="">
                    <div class="text-start ps-4">
                        <form action="respPracSave" method="POST">
                            @csrf
                            <table class="table table-w">
                                ...
                                <tbody>
                                <tr>
                                    <td><input type="text" size="10" name="pozicia"> </td>
                                    <td>
                                        <select name="firma" id="firma">
                                            <?php
                                            $firma = DB::table('Firma')->get();
                                            foreach ($firma as $firm){
                                                echo "<option value='".$firm->idFirma."'>".$firm->Názov_firmy."</option>";
                                            }
                                            ?>
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-danger" href="respPracRead">Zrušiť</a>
                                        </div>
                                    </td>
                                </tr>
                                </tbody>
