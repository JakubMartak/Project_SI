<head>
    ...
    <style>
        /* Template Stylesheet */
        <?php
            $praxy = DB::table('Prax')->join('Prax_has_Dokumenty', 'Prax_has_Dokumenty.Prax_idPrax', '=', 'Prax.idPrax')->join('Dokumenty', 'Dokumenty.idDokumenty', '=', 'Prax_has_Dokumenty.Dokumenty_idDokumenty')->where('Student_idPouzivatel', Auth::user()->id)->where('Typ_doc', 'Vykaz_o_vykonani_praxe')->orderBy('idPrax')->get();
        ?>
